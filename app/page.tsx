      ...
      <div className="flex items-center w-full h-full bg-cover bg-center" style={{ backgroundImage: "url(/main-bg.jpg)" }}>
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
          ...
          <p className="text-gray-200 hidden md:block">
            As a enthusiastic and passionate engineer,
            I thrive on exploring and implementing the latest technologies to create innovative solutions
          </p>
          <div className="flex-col md:flex-row hidden md:flex gap-5">
            ...
            <Link href="/my-projects" className="rounded-[20px] relative group bg-blue-500 hover:bg-blue-400 px-5 py-3 text-lg text-white max-w-[200px]">
